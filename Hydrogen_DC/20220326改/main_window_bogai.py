...
class ST_Win(tk.Tk):
    ...
    def showtable(self):
        ...
        tree.column("BUS4",width=30, anchor = "center")
        
        #设置表头
        tree.heading("BUS1",text="母线1")
        tree.heading("BUS2",text="母线2")
        tree.heading("BUS3",text="母线3")
        tree.heading("BUS4",text="母线4")
        
        #添加数据
        tree.insert("",0,text="母线1",values=("0","0","0","0"))#  0 为列的下标，第0行
        tree.insert("",1,text="母线2",values=("0","0","0","0"))
        tree.insert("",2,text="母线3",values=("0","0","0","0"))
        tree.insert("",3,text="母线4",values=("0","0","0","0"))
